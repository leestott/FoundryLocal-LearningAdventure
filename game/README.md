...
![Welcome Screen](screenshots/01-welcome-screen.svg)

### Main Menu - Level Selection
After entering your name, choose from 5 progressive levels:

![Main Menu](screenshots/03-main-menu.svg)

### Level 1 - Meet the Model
Your first interaction with an AI model:

![Level 1](screenshots/04-level1-meet-model.svg)

### AI Response
Watch the AI respond to your prompts in real-time:

![AI Response](screenshots/05-level1-response.svg)

### Sage - Your AI Mentor
Get help anytime from Sage, your friendly mentor:

![Mentor Chat](screenshots/06-mentor-chat.svg)

### Hint System
Stuck? Use hints to guide your learning:

![Hint System](screenshots/07-hint-system.svg)

### Progress Tracking
Track your points, badges, and completion status:

![Progress Modal](screenshots/08-progress-modal.svg)

### Badge Collection
Earn badges as you master each concept:

![Badges](screenshots/09-badges-collection.svg)
...
├── tests/                  # Test files
│   ├── test-game.js       # Full test suite
│   ├── check-foundry.ps1  # Windows health check
│   └── check-foundry.sh   # Mac/Linux health check
├── start-game.bat         # Windows launcher (double-click!)
